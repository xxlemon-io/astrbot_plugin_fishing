...
- **社交功能**：排行榜、偷鱼、成就称号系统
- **全新商店系统**：多类型商店（普通/高级/限时），支持复杂消耗和奖励机制
- **库存管理系统**：完整的用户道具、装备、鱼类库存管理
- **线程安全架构**：数据库连接管理器，支持高并发访问
...
- **全新商店系统**：支持普通/高级/限时三种商店类型，复杂消耗和奖励机制
- **库存管理系统**：完整的用户道具、装备、鱼类库存管理，支持批量操作
- **线程安全架构**：数据库连接管理器，支持高并发访问，提升系统稳定性
- **Web管理界面升级**：新增商店管理、库存管理模块，完善后台功能
- **数据库优化**：新增多个数据表支持商店和库存功能，优化查询性能
- **代码重构**：统一仓储接口，提升代码可维护性和扩展性
- **新增命令**：商店相关命令，库存管理命令，提升用户体验
...
| `/购买鱼竿 [ID]` | - | 从商店购买鱼竿 |
| `/购买鱼饵 [ID]` | - | 从商店购买鱼饵 |
| `/购买商店 [ID] [数量]` | `/商店购买 [ID] [数量]` | 从新商店系统购买商品 |
| `/市场` | - | 查看玩家交易市场 |
| `/上架鱼竿 [ID] [价格]` | - | 将鱼竿上架市场 |
| `/上架饰品 [ID] [价格]` | - | 将饰品上架市场 |
| `/上架道具 [ID] [价格]` | - | 将道具上架市场 |
...
- **多类型商店**：支持普通商店、高级商店、限时商店三种类型
- **复杂消耗机制**：支持金币、高级货币、道具、鱼类等多种消耗方式
- **丰富奖励系统**：可配置多种奖励类型，支持礼包和单件奖励
- **库存管理**：每个商店可独立设置商品库存和限购规则
- **时间控制**：支持商店开放时间设置，实现限时活动
- **Web管理**：管理员可通过后台界面轻松管理商店和商品
