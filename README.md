...
| `/饰品` | - | 查看我的饰品 |
| `/道具` | `/我的道具`、`/查看道具` | 查看我的道具 |
| `/使用 [ID]` | `/装备 [ID]` | 使用指定ID的道具/装备 |
| `/开启全部钱袋` | `/打开全部钱袋`、`/打开所有钱袋` | 一次性开启所有钱袋类道具 |
| `/出售道具 [ID] [数量]` | `/卖出道具 [ID] [数量]` | 出售指定ID和数量的道具 |
| `/精炼 [ID]` | `/强化 [ID]` | 精炼指定ID的鱼竿或饰品 |
| `/精炼帮助` | `/精炼说明` | 查看精炼系统详细说明 |
| `/锁定 [ID]` | `/上锁 [ID]` | 锁定指定ID的鱼竿或饰品，防止误操作 |
| `/解锁 [ID]` | `/开锁 [ID]` | 解锁指定ID的鱼竿或饰品，允许正常操作 |
| `/金币` | - | 查看金币余额 |
| `/高级货币` | `/钻石`、`/星石` | 查看高级货币余额 |
...
| `/商店购买 [商店ID] [商品ID] [数量]` | `/购买商店商品 [商店ID] [商品ID] [数量]`、`/购买商店 [商店ID] [商品ID] [数量]` | 从指定商店购买商品（支持复杂成本机制） |
| `/市场` | - | 查看玩家交易市场 |
| `/上架 [ID] [价格]` | - | 将物品上架到市场 |
| `/购买 [ID]` | - | 从市场购买商品 |
