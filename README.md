...
[![Version](https://img.shields.io/badge/Version-2.2.4-brightgreen.svg)](https://github.com/xxlemon-io/astrbot_plugin_fishing/releases/tag/v2.2.4)
...
- **✨ 移除表情符号**：删除排行榜中的emoji（钓获、金币、装备），界面更简洁
