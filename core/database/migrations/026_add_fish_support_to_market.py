...
def up(cursor: sqlite3.Cursor):
    ...
    """
    print("正在执行 026_add_fish_support_to_market: 更新market表约束以支持鱼类类型...")
    ...
    print("market表约束更新完成，现在支持rod、accessory、item和fish类型")
...
def down(cursor: sqlite3.Cursor):
    ...
    回滚：移除对fish类型的支持
    """
    print("正在回滚 026_add_fish_support_to_market: 移除fish类型支持...")
    ...
    cursor.connection.commit()
    print("market表约束回滚完成，现在只支持rod、accessory和item类型")
