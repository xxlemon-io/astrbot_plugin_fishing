...
BAIT_DATA = [
    ...
    ('亮片拟饵', '旋转时能反光的基础金属拟饵。', 2, '略微提高掠食性鱼类上钩率，无消耗', 0, 50, 1),
    ('腥味颗粒饵', '商业生产的鱼饵，气味浓烈。', 2, '提高多种淡水鱼上钩率', 0, 30, 1),
    ('万能饵', '精心调配，对大多数鱼类都有效果。', 3, '提高所有鱼种上钩率', 0, 100, 0),
    ('活虾', '活蹦乱跳的虾，是许多鱼类的美味。', 3, '显著提高中大型海鱼上钩率', 0, 80, 1),
    ('驱散垃圾饵', '散发着垃圾鱼讨厌的气味。', 3, '降低钓上 Rarity 1 垃圾的概率', 30, 250, 1),
    ('秘制香饵', '用特殊配方制成，对稀有鱼类极具诱惑力。', 4, '显著提高 Rarity 3及以上鱼的上钩率', 0, 500, 2),
    ('价值连城饵', '散发着财富的气息。', 4, '钓上的鱼基础价值+10%', 0, 700, 3),
    ('大师拟饵', '由钓鱼大师制作的完美拟饵。', 4, '大幅提高掠食性鱼类上钩率，无消耗', 0, 1000, 3),
...
GACHA_POOL = [
    ...
    (1, '鱼竿抽奖池', '含有高级鱼竿', 5000, 0),
    (2, '饰品抽奖池', '含有各类钓鱼饰品', 10000, 0),
]
