...
FISH_DATA = [
    ...
    ("时间沙漏", "据说能短暂地影响时间流逝的神器部件。", 5, 20000, 300, 1000, None),
    ...
    ("创世神鳞", "创造万物的神明遗留的鳞片，拥有无穷的创造力。", 8, 1000000, 1, 1, None),
]
...
ITEM_DATA = [
    ...
    (
        ...
        4,
        "获得1次精炼保护（毁坏改判为普通失败，本体保留不降级）。[仅对5星及以下装备生效]",
        0,
        False,
        None,
    ...
    (
        ...
        5,
        "获得1次至高保护（毁坏必改为普通失败，本体保留不降级）。[对所有星级装备均有效]",
        0,
        False,
        None,
        "REFINE_DESTRUCTION_SHIELD",
