...
def register_admin_handlers(plugin):
    ...
    plugin.add_handler(modify_coins)
    plugin.add_handler(modify_premium)
    plugin.add_handler(reward_premium)
    plugin.add_handler(deduct_premium)
    plugin.add_handler(reward_all_coins)
    plugin.add_handler(reward_all_premium)
    plugin.add_handler(deduct_all_coins)
    plugin.add_handler(deduct_all_premium)
    plugin.add_handler(reward_coins)
    plugin.add_handler(deduct_coins)
    plugin.add_handler(start_admin)
    plugin.add_handler(stop_admin)
    plugin.add_handler(sync_items_from_initial_data)
    plugin.add_handler(impersonate_start)
    plugin.add_handler(impersonate_stop)
