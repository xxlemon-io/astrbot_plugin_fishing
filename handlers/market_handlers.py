...
def register_market_handlers(plugin):
    ...
    plugin.context.add_handler(sell_all)
    plugin.context.add_handler(sell_keep)
    plugin.context.add_handler(sell_everything)
    plugin.context.add_handler(sell_by_rarity)
    plugin.context.add_handler(sell_rod)
    plugin.context.add_handler(sell_all_rods)
    plugin.context.add_handler(sell_accessories)
    plugin.context.add_handler(sell_all_accessories)
    plugin.context.add_handler(shop)
    plugin.context.add_handler(buy_rod)
    plugin.context.add_handler(buy_bait)
    plugin.context.add_handler(market)
    plugin.context.add_handler(list_rod)
    plugin.context.add_handler(list_accessories)
    plugin.context.add_handler(list_item)
    plugin.context.add_handler(buy_item)
    plugin.context.add_handler(my_listings)
    plugin.context.add_handler(delist_item)
